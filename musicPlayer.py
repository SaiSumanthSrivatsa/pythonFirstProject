...
import pygame
import os
path=input("Enter the path for music directory")
...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    self.playlist = Listbox(songsframe,yscrollcommand=scrol_y.set,selectbackground="gold",selectmode=MULTIPLE,font=("times new roman",12,"bold"),bg="silver",fg="navyblue",bd=5,relief=GROOVE)
